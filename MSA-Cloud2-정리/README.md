...
- 2-phase commit 패턴(2PC) : 다른 서비스에 장애가 발생하거나, Locking상태에 빠지면 영향을 줌.
![image](https://user-images.githubusercontent.com/35188271/165658459-4b557600-6ad8-4a72-ae50-4f983ad39954.png)

```
기존에 사용하던 2PC 패턴은 DB연결을 통해서 Prepare, Commit 두가지의 phase를 통해서 데이터베이스 세션 확인과정이 있지만
Prepare이나 Commit중에 DB가 응답이 없으면 Locking이거나 대기상태에 빠짐.
